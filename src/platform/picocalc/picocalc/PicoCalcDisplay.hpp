...
public:
    ...
    void presentIndexed8(const uint8_t* pixels, int w, int h, const uint16_t* palette);
    void endFrame();
    ...
    // Current fixed-engine framebuffer size for the PicoCalc path.
    static constexpr int RenderW = 320;
    static constexpr int RenderH = 240;
