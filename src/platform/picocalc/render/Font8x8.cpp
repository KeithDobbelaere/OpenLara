...
const std::array<Glyph, kGlyphCount> kGlyphs = {{
    //  32 ' '
    ...
    //  38 '&'
    {{0x1C,0x22,0x14,0x28,0x55,0x42,0x3D,0x00}},
    //  39 '''
    ...
    // 109 'm'
    {{0x00,0x00,0x6C,0x52,0x52,0x42,0x42,0x00}},
    // 110 'n'
    ...
    // 127 custom star
    {{0x18,0x18,0xFF,0x7E,0x3C,0x7E,0x66,0x81}}
}};
